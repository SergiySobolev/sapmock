package com.zaelab.sapmock.jalo;
...
public class SapmockManager extends GeneratedSapmockManager
{
	private static final Logger LOG = LoggerFactory.getLogger(SapmockManager.class);
	 ...
	 */
	public static SapmockManager getInstance()
	{
		return (SapmockManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapmockConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapmockManager() // NOPMD 
	{
		LOG.debug("constructor of SapmockManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapmockManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapmockManager called, current tenant: {}", getTenant().getTenantID());
	}
